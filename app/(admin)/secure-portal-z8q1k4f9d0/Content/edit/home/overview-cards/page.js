...
const OverviewCardsEditPage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-white px-6 py-8">
      ...
      {/* Add form fields for overview cards editing */}
      ...
      <ConfirmationDialog
        ...
        title="Save Changes"
        message="Are you sure you want to save these changes to the overview cards?"
        confirmText="Save"
        cancelText="Cancel"
        type="info"
      />
...
export default OverviewCardsEditPage;